/**
 * @sobra/shared — Sobra Engine
 *
 * Core calculation module. The heart of the Sobra product.
...
import { isActiveInMonth, getMonthPeriod, getRemainingDaysInMonth } from './calc'
