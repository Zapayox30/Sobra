...
import { Menu, X, PlusCircle, LayoutDashboard, DollarSign, TrendingDown, Target, ChevronDown, LogOut, TrendingUp, CreditCard, Landmark, Receipt, PiggyBank, Link2, Shield, GraduationCap } from 'lucide-react'
...
export function MobileNav() {
  ...
  const navigation = [
    ...
    { name: t.nav.debts, href: '/debts', icon: Receipt },
    { name: t.nav.savings, href: '/savings', icon: PiggyBank },
    { name: t.nav.emergencyFund, href: '/emergency-fund', icon: Shield },
    { name: t.nav.investments, href: '/investments', icon: TrendingUp },
    { name: t.nav.education, href: '/education', icon: GraduationCap },
    { name: t.nav.bankConnections, href: '/bank-connections', icon: Link2 },
  ]
