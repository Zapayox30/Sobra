...
export default function ExpensesScreen() {
  ...
  function handleQuickAddSave(val: number, catId: string, fullLabel: string) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Frictionless Quick Add Modal for Personal Expenses */}
      <QuickAddModal 
        visible={showQuickAdd}
        onClose={() => setShowQuickAdd(false)}
        onSave={handleQuickAddSave}
        isSubmitting={createPersonal.isPending}
      />
    </View>
  )
}
